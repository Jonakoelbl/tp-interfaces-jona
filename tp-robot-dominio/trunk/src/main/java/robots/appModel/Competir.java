...
public class Competir {
	...
	public Competir(Jugador unJugador, Robot unDesafiante, Robot unContrincante) {
	...
	public void competirPorHonor(){
		this.tienda.competir(this.apuestaRealizada, this.robotSeleccionado, this.getContrincanteSeleccionado());
	}
	
	public String getNombreRobotSeleccionado(){
